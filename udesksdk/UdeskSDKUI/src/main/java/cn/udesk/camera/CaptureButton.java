...
import static cn.udesk.camera.UdeskCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static cn.udesk.camera.UdeskCameraView.BUTTON_STATE_ONLY_RECORDER;
...
public class CaptureButton extends View {
    ...
    private int progress_color = 0xFF2D93FA;            //进度条颜色
    private int outside_color = 0xE6D8D8D8;             //外圆背景色
    ...
    private void updateProgress(long millisUntilFinished) {
        ...
        try {
            ...
            if (captureLisenter != null) {
                captureLisenter.recordTime(recorded_time);
            }
