...
public class LocationAdapter extends BaseAdapter {
    ...
    public LocationAdapter(Context context, List<Geo2AddressResultObject.ReverseAddressResult.Poi> datas) {
        this.datas = datas;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (datas != null && datas.size() > 0) {
            Geo2AddressResultObject.ReverseAddressResult.Poi poiInfo = datas.get(position);
            viewHolder.tv_poi_address.setText(poiInfo.address);
            viewHolder.tv_poi_name.setText(poiInfo.title);
